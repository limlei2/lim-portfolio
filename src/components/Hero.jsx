...
const socialLinks = [
    {
        ...
        imgSrc: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
        ...
        imgSrc: <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="container items-center lg:grid lg:grid-cols-2 lg:gap-10">
            ...
            <div className="hidden lg:block">
                <figure className="w-full max-w-[480px] 
                    ml-auto bg-gradient-to-t from-sky-600 
                    via-25% via-sky-400/40 to-90% rounded-[60px] 
                    overflow-hidden"
                >
                    <img 
